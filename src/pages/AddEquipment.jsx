...
const AddEquipment = () => {
    ...
    const handleSubmit = event => {
        ...
        const allProducts = { name, category, description, price, delivery, stock, image }
        ...
        <>
            <div className="bg-base-300 ">
                <div className="w-11/12 mx-auto py-24">
                    <div><h1 className="text-3xl font-bold text-center pb-5">Add Product</h1></div>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="md:flex gap-8 pb-3">
                            <label className="form-control md:w-1/2 ">
                                ...
                                <input type="text" name="delivery" placeholder="Enter Product Delivery Time" className="input input-bordered w-full " />
                            </label>
                            <label className="form-control md:w-1/2 ">
                                <div className="label">
                                    <span className="label-text text-xl font-semibold">Stock Status</span>
                                </div>
                                <input type="number" name="stock" placeholder="Enter Product Quantity" className="input input-bordered w-full " />
                            </label>
                        </div>
                        {/* 4th row */}
                        <div className="md:flex gap-8">
                            <label className="form-control md:w-1/2 ">
                                ...
                                <input type="text" name="image" placeholder="Enter Product Image URL" className="input input-bordered w-full " />
                            </label>
                            <label className="form-control md:w-1/2 ">
                                <div className="label">
                                    <span className="label-text text-xl font-semibold">Customization </span>
                                </div>
                                <input type="text" name="customization" placeholder="Enter Product Customization " className="input input-bordered w-full " />
                            </label>
                        </div>
                        {/* 4th row */}
                        <div className="md:flex gap-8">
                            <label className="form-control md:w-1/2 ">
                                ...
                                <input type="text" name="" placeholder="Enter Product Image URL" className="input input-bordered w-full " />
                            </label>
                            <label className="form-control md:w-1/2 ">
                                <div className="label">
                                    <span className="label-text text-xl font-semibold">User Email</span>
                                </div>
                                <input type="email" name="" placeholder="Enter Product Customization " className="input input-bordered w-full " />
                            </label>
                        </div>
                        <input className="w-full p-2 bg-gray-600 text-white mt-4" type="submit" value="Add Product" />
                    </form>
                </div>
            </div>
        </>
